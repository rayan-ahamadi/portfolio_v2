...
export default function About() {
  ...
  useGSAP(() => {
    ...
    tl.to("header a, #header-occupation", { color: "#d7dae1" }, 0)
      .to(navLinkAfterRule, { cssRule: { backgroundColor: "#d7dae1" } }, 0)
      .to("#burgerButton", { fill: "#d7dae1" }, 0);
      ...
      <Container className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-6 p-28">
        <div className="col-span-4 md:col-span-8 lg:col-span-12">
          ...
          <h2 className="text-primary font-primary font-bold uppercase lg:text-[67px] leading-[0.8]">
            <HiddenTextReveal startViewport="25%">About Me</HiddenTextReveal>
          </h2>
        </div>
        ...
        <div className="col-span-4 lg:col-start-3 lg:col-span-7 py-6 md:py-14 lg:py-28 z-50">
          <LineBlockReveal>
            <p className="font-primary text-primary font-regular leading-normal md:leading-14 tracking-tight text-2xl md:text-4xl lg:text-5xl z-[55] uppercase">
              ...
              program. I design and build{" "}
              <span className="text-accent"> interactive</span> interfaces with
              a strong attention to <span className="text-accent">motion</span>,{" "}
              <span className="text-accent">structure</span>, and{" "}
              <span className="text-accent">visual identity</span>. aiming to
              create meaningful and expressive digital experiences.
            </p>
          </LineBlockReveal>
        </div>
