...
export default function Hero() {
    return <section className="bg-secondary min-h-screen h-auto pt-12">
        <Container className="grid grid-cols-12 gap-6">
            <FleurFooter className="absolute h-auto bottom-[15vh] pointer-events-none select-none z-0 w-128.25 left-[35vw]" />
