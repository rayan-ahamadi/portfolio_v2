        ...
        <ProjectLayout className="grid grid-cols-12 gap-6">
          ...
          <ProjectLayout.Description>
            ...
            <p className="font-light text-xl md:text-2xl lg:text-3xl normal-case leading-normal md:leading-10">
              Café Ronron is a personal experimental project based on a
              fictional cat café concept. The goal of this project is to explore
              motion design and user experience through animation, using GSAP as
              a core tool. Rather than focusing on completeness, the project
              acts as a creative playground where ideas, transitions, and visual
              rhythm are continuously tested and refined.
            </p>
          </ProjectLayout.Description>
          <ProjectLayout.Bento>
            ...
            <BentoGrid>
              ...
              <BentoItem colSpan={1} mdColSpan={3} lgColSpan={7}>
                <div className="flex flex-col justify-center h-full">
                  <h3 className={`text-3xl ${claytonia.className}`}>
                    Claytonia
                  </h3>
                  <p className={`${playfair.className} font-light text-2xl`}>
                    Playfair Display
                  </p>
                  <p className={`${poppins.className} font-light text-2xl`}>
                    Poppins
                  </p>
                </div>
              </BentoItem>
