      ...
      <main className="relative z-10">
        ...
        <ProjectLayout className="grid grid-cols-12 gap-6">
          <ProjectLayout.Hero>
            ...
            <div className="rounded-lg flex flex-col justify-center items-center overflow-hidden p-4 md:p-6 lg:p-8 bg-[#96a2d0] h-max">
              <Image
          ...
          <ProjectLayout.Description>
            ...
            <h3 className="font-semibold mb-7 text-2xl md:text-3xl lg:text-4xl uppercase">
              Description
            </h3>
            <p className="font-light text-xl md:text-2xl lg:text-3xl normal-case leading-normal md:leading-10">
              CBM Blog is a static website dedicated to superhero movies and TV
              series. Built using only HTML and CSS, this project was my first
              complete front-end experience during my studies. It focuses on
              layout and content structure and represents an important milestone
              in my understanding of the fundamentals of the web.
            </p>
          </ProjectLayout.Description>
          <ProjectLayout.Bento>
            ...
            <BentoGrid>
              ...
              <BentoItem colSpan={1} mdColSpan={3} lgColSpan={7}>
                <div className="flex flex-col justify-center h-full">
                  <h3
                    className={`font-extrabold text-3xl uppercase ${bebaNeue.className}`}
                  >
                    Bebas Neue
                  </h3>
                  <p className={`font-light text-2xl ${publicSans.className}`}>
                    Public Sans
                  </p>
                </div>
              </BentoItem>
              ...
              <BentoItem
                ...
                mdColSpan={3}
                lgColSpan={6}
                bgColorClass="bg-[#96a2d0]"
              >
                <div className="flex flex-col justify-center h-full">
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold uppercase">
                    Intent :
                  </h3>
                  <p className="text-lg md:text-xl lg:text-2xl font-light normal case">
                    Create a static blog to share my passion for superhero
                    movies and series.
                  </p>
                </div>
              </BentoItem>
