      ...
      <main className="relative z-10">
        ...
        <ProjectLayout className="grid grid-cols-12 gap-6">
          <ProjectLayout.Hero>
            ...
            <div className="rounded-lg flex flex-col justify-center items-center overflow-hidden p-4 md:p-6 lg:p-8 bg-[#FF99CF] h-max">
              <Image
          ...
          <ProjectLayout.Description>
            ...
            <h3
              className={
                "font-semibold mb-4 text-2xl md:text-3xl lg:text-4xl uppercase"
              }
            >
              Description
            </h3>
            <p className="font-light text-xl md:text-2xl lg:text-3xl normal-case leading-normal md:leading-10">
              Bloop is a fictional social media platform inspired by Twitter,
            ...
            <BentoGrid>
              ...
              <BentoItem colSpan={1} mdColSpan={3} lgColSpan={7}>
                <div className="flex flex-col justify-center h-full">
                  <h3
                    className={`font-black text-3xl uppercase ${proximaNova.className}`}
                  >
                    Proxima Nova Extra Condensed
                  </h3>
                  <p className={`font-light text-2xl ${proximaNova.className}`}>
