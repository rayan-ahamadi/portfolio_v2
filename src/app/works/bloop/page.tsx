            ...
            <main className="relative z-10">
                ...
                <ProjectLayout className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-6">
                    <ProjectLayout.Hero>
                        ...
                        <div className="mb-15">
                            <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold uppercase mb-4 md:mb-6 lg:mb-9">Bloop</h1>
                            <div className="">
                    ...
                    <ProjectLayout.Description>
                        ...
                        <h3 className={"font-semibold mb-4 text-2xl md:text-3xl lg:text-4xl uppercase"}>Description</h3>
