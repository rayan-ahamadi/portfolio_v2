...
export default function LoadingScreen() {
  return (
    <div
      ...
      className="fixed inset-0 z-[49] grid grid-cols-12 grid-rows-12"
    >
      ...
      <div
        id="text-loader"
        className="absolute inset-0 flex items-center justify-center z-[49] pointer-events-none uppercase"
      >
        <svg
