        ...
        <div className="col-span-4 md:col-span-8 lg:col-span-12 flex flex-col md:flex-row justify-between items-center py-7 uppercase">
          ...
          >
            ...
            <span
              ...
              className="font-medium font-primary text-secondary text-[length:var(--fluid-header-occupation)] normal-case select-none mix-blend-difference"
            >
              Creative Developer
            </span>
          </NewLink>
          <nav className="block">
            <ul className="font-semibold font-primary text-secondary text-[length:var(--fluid-header-link)] flex gap-6">
              {pathname === "/" ? (
                <>
                  <Link
                    href="#works"
                    className="underlined-text mix-blend-difference"
                  >
                    <li>Projects</li>
                  </Link>
                  <Link
